...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Harsh@012345',db='cv')
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome User! Total %d " % values + " User's Have Used Our Tool : )")                
